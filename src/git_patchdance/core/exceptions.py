...
class GitError(GitPatchError):
    ...
    access errors, invalid references, or git command failures.
    
    Attributes:
        message: Human-readable error description
        git_error: Optional underlying git exception that caused this error
    """
...
class IoError(GitPatchError):
    ...
    Attributes:
        message: Human-readable error description  
        io_error: Optional underlying IO exception that caused this error
    """
